...
export default function TermsPage() {
  return (
    <LegalLayout
      ...
      updated="30 May 2026"
      intro="Please read these Terms & Conditions carefully before using ElectroKart. By accessing or using our website, you agree to be bound by these terms."
    >
      <LegalSection heading="Use of the site">
        <p>
          You agree to use ElectroKart only for lawful purposes and in a way that does not infringe
      ...
      <LegalSection heading="Intellectual property">
        <p>
          ...
          ElectroKart or its licensors and is protected by applicable intellectual-property laws. You
      ...
      <LegalSection heading="Limitation of liability">
        <p>
          ElectroKart is not liable for any indirect or consequential loss arising from the use of our
