    ...
    <section className="relative w-full overflow-hidden">
                  ...
                  <div className="container">
                    <div className="max-w-xl space-y-6">
                      <motion.h2
                        ...
                        className="text-display-lg sm:text-display-xl font-heading text-white"
                      >
                      ...
                      {slides[current].subtitle && (
                        <motion.p
                          ...
                          className="text-body-lg text-white/80 max-w-md"
                        >
                          {slides[current].subtitle}
                        </motion.p>
                      )}
      ...
      {total > 1 && (
        <>
          <button
            onClick={prev}
            className="absolute left-4 top-1/2 -translate-y-1/2 flex h-10 w-10 items-center justify-center rounded-full bg-white/10 text-white backdrop-blur-sm border border-white/20 transition-all hover:bg-white/20 hover:scale-110 z-10"
          ...
          <button
            onClick={next}
            className="absolute right-4 top-1/2 -translate-y-1/2 flex h-10 w-10 items-center justify-center rounded-full bg-white/10 text-white backdrop-blur-sm border border-white/20 transition-all hover:bg-white/20 hover:scale-110 z-10"
