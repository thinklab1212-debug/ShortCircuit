            ...
            ? categories.map((cat) => (
                <motion.div key={cat._id} variants={fadeInUp}>
                  <Link
                    ...
                    className="group glass flex flex-col items-center gap-2 sm:gap-3 rounded-2xl p-4 sm:p-6 transition-all duration-300 hover:shadow-card-hover hover:-translate-y-1 hover:border-primary/25"
                  >
                    {cat.image?.url ? (
                      ...
                      <div className="flex h-11 w-11 sm:h-14 sm:w-14 items-center justify-center rounded-xl bg-primary/10 text-primary transition-colors group-hover:bg-primary/15">
                ...
                return (
                  <motion.div key={cat.slug} variants={fadeInUp}>
                    <Link
                      ...
                      className="group glass flex flex-col items-center gap-2 sm:gap-3 rounded-2xl p-4 sm:p-6 transition-all duration-300 hover:shadow-card-hover hover:-translate-y-1 hover:border-primary/25"
                    >
                      <div className="flex h-11 w-11 sm:h-14 sm:w-14 items-center justify-center rounded-xl bg-primary/10 text-primary transition-transform group-hover:scale-105">
