...
export function OrganizerLayout() {
  ...
  const isActive = (href: string) => {
    ...
    if (href === '/organizer/events/new') return location.pathname === '/organizer/events/new'
    if (href === '/organizer/events') return location.pathname.startsWith('/organizer/events')
    return location.pathname.startsWith(href)
  }

  return (
    <div className="flex h-screen overflow-hidden bg-background">
      <ScrollToTop selector="#organizer-main" />
