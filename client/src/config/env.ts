...
const env = {
  ...
  APP_NAME: import.meta.env.VITE_APP_NAME as string || 'ElectroKart',
  APP_DESCRIPTION: import.meta.env.VITE_APP_DESCRIPTION as string || 'Premium Electronics Marketplace',
