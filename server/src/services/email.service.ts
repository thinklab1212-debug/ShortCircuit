...
export class EmailService {
  ...
  /**
   * Sends a contact us form submission notification to the admin.
   */
  public static async sendContactInquiryEmail(
    inquirerName: string,
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 25px; border: 1px solid #e2e8f0; border-radius: 12px; background-color: #ffffff;">
        ...
        <table style="width: 100%; border-collapse: collapse; margin-bottom: 25px;">
          <tr>
            ...
            <td style="padding: 10px 0; color: #334155; border-bottom: 1px solid #f1f5f9; font-size: 14px;">${inquirerName}</td>
          </tr>
          <tr>
            ...
            <td style="padding: 10px 0; color: #4f46e5; border-bottom: 1px solid #f1f5f9; font-size: 14px;"><a href="mailto:${inquirerEmail}" style="color: #4f46e5; text-decoration: none;">${inquirerEmail}</a></td>
          </tr>
          <tr>
    ...
    try {
      ...
      logger.info(`📧 Contact inquiry email sent successfully to: ${adminEmail}`);
      return true;
    } catch (error) {
